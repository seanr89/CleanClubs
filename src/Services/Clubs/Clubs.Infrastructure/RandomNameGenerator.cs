...
namespace Clubs.Infrastructure
{
     public class RandomNameGenerator
    {
        ...
        string[] _firstnames = new string[] {"Aaran", "Aaron", "Aarron", "Abraham", "Abu", "Ace", "Adam", "Addison", "Adegbola",
                ...
                "Aodhan", "Aonghus", "Aran", "Arandeep", "Arann", "Aray", "Archibald", "Archie",
                "Arnold", "Arthur", "Artur", "Arya", "Ashtyn", "Ashwin", "Aslam", "Asrar",
                "Austin", "Bailey", "Bailie", "Benedict", "Benjamin", "Benjamyn", "Benji", "Bennett", "Benny", "Bernard", "Bertie", "Bevin", "Bill", "Billy",
                "Blaine", "Blair", "Blake", "Bob", "Bobby", "Brad", "Bradan", "Braden", "Bradley",
                 ...
                 "Brogan", "Broghan", "Brooke", "Brooklin", "Brooklyn", "Bruce", "Bruin", "Bruno", "Brunon", "Bryan", "Bryce", "Cahlum", "Cailin",
                 "Callum", "Callun", "Callyn", "Calum", "Calum-James", "Calvin", "Cambell", "Camerin", "Cameron", "Campbel", "Campbell", "Camron",
                 ...
                 "Cillian", "Cillin", "Cinar", "CJ", "C-Jay", "Clark", "Clarke", "Clayton", "Clement", "Clifford", "Clyde", "Cobain",
                 "Coban", "Coben", "Cobi", "Cobie", "Coby", "Codey", "Codi", "Codie", "Cody", "Cody-Lee", "Coel", "Cohan", "Cohen", "Colby", "Cole", "Colin", "Colm", "Colt", "Colton", "Conal", "Conall", "Conan",
                 ...
                 "Daren", "Darien", "Darius", "Darl", "Darn", "Darrach", "Darragh", "Darrel", "Darrell", "Darren", "Darrie", "Darrius", "Darroch", "Darryl", "Darryn", "Darwyn", "Daryl", "David",
                 "Deacon", "Deagan", "Dean", "Deano", "Decklan", "Declain", "Declan", "Deegan", "Deelan", "Deklain-Jaimes", "Del", "Demetrius", "Denis", "Deniss", "Dennan", "Dennin", "Dennis",
                 "Devyn", "Dex", "Dexter", "Dhani", "Dharam", "Dhavid", "Dhyia", "Diarmaid", "Diarmid", "Diarmuid", "Didier", "Diego", "Digby", "Dilan", "Dilano", "Dillan", "Dillon", "Dimitri", "Dolan", "Domhnall",
                 ...
                 "Enrique", "Enzo", "Eoghain", "Eoghan", "Eoin", "Eric", "Ericlee", "Erik",
                 "Esteban", "Ethan", "Etienne", "Euan", "Eugene", "Evan", "Evann", "Ewan", "Ezekiel", "Ezra", "Fabian",
                  ...
                  "Markus", "Marley", "Marlin", "Marlon", "Maros", "Marshall", "Martin", "Marty", "Martyn", "Marvellous", "Marvin", "Marwan", "Maryk", "Marzuq", "Mashhood", "Mason", "Mason-Jay", "Mathew", "Mathias", "Mathuyan", "Matt", "Matteo", "Matthew", "Matthias", "Max", "Micah", "Michael", "Mickey", "Miguel", "Miles", "Mitch", "Mitchel", "Mitchell", "Moad", "Moayd", "Morris", "Murray", "Nader", "Nate", "Nathan", "Neil", "Nelson", "Nial", "Niall", "Nicholas", "Nick", "Nicolas",
                  "Odhran", "Odin", "Odynn", "Ogheneochuko", "Ogheneruno", "Ohran", "Oilibhear", "Oisin", "Ojima-Ojo", "Okeoghene", "Olaf", "Ola-Oluwa", "Olaoluwapolorimi", "Ole", "Olie", "Oliver", "Olivier", "Ollie", "Oran", "Orin", "Orlando", "Orley", "Orran",
                  "Orrick", "Orrin", "Orson", "Oryn", "Oscar", "Oswald", "Otto", "Owain", "Owais", "Owen", "Owyn", "Oz", "Ozzy", "Pablo", "Pacey", "Padraig", "Paolo", "Pardeepraj", "Parkash", "Parker", "Patrick", "Patrick-John", "Paul", "Pavit", "Pawel", "Pawlo", "Pearce", "Pearse", 
                  ...
                  "Sergei", "Sergio", "Seth", "Sethu", "Seumas", "Shaarvin", "Shadow", "Shae", "Shahmir", "Shai", "Shane", "Shannon", "Sharland", "Sharoz", "Shaughn", "Shaun", "Shaunpaul", "Shaun-Paul", "Shaun-Thomas", "Shaurya", "Shaw",
                  "Shawn", "Shea", "Simon", "Stefan", "Stephen", "Stephenjunior", "Steve", "Steven", "Steven-lee", "Stevie", "Stewart", "Stuart", "Surien", "Sweyn", "Syed", "Symon", "Tadhg", "Taegan", "Taegen",  "Tanay", "Tane", "Tanner", "Tanvir", "Tanzeel", "Taonga", "Taylor", "Teagan", "Tee", "Teejay", "Tee-jay", "Tegan", "Teighen", "Terry", "Teydren", "Theo", "Theodore", "Thomas", "Tiernan", "Timothy", "Tom", "Tomas", "Tomasz", "Tommy", "Tony",
                   "Victor", "Victory", "Vince", "Vincent", "Vincenzo", "Vinnie", "Vladimir", "Warren", "Warrick", "Wayde", "Wayne", "Will", "William", "Wilson", "Windsor", "Wojciech", "Wyatt", "Wylie", "Wynn", "Xander", "Xavier", "Yanick", "Zach", "Zachariah", "Zacharias", "Zacharie", "Zacharius", "Zachariya", "Zachary", "Zachary-Marc", "Zachery", "Zack", "Zackary", "Zane"};
